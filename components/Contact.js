export default function Contact() {
    return (
      <section>
        <div className="h-[1000px] shadow-lg box-border text-center relative overflow-hidden">
                ...
                <div className="flex mx-auto">
                  <div className="mr-4">
                    <div className="text-left">
                      <label className="text-[#33475b] text-[16px]">First name</label>
                    </div>
                    <div className="mt-4">
                  ...
                  <div className="ml-4">
                    <div className="text-left">
                      <label className="text-[#33475b] text-[16px]">Last name</label>
                    </div>
                    <div className="mt-4">
                      <input className="border-b-[2px] border-[#cad5e2]"></input>
                    </div>
              ...
              <div className="">
                <div className="">
                  <div className="mr-60 mt-6">
                    <label className="text-[#33475b] text-[16px]">Mobile Phone Number</label>
                  </div>
                  <div className="mt-4">
              ...
              <div className="">
                <div>
                  <div className="mr-[290px] mt-6">
                    <label className="text-[#33475b] text-[16px]">Company name</label>
                  </div>
                  <div className=" mt-4">
                    <input className="w-[404px] border-b-[2px] border-[#cad5e2]"></input>
                  </div>
              ...
              <div className="">
                <div>
                  <div className="mr-[220px] mt-6">
                    <label className="text-[#33475b] text-[16px]">What are you looking for?</label>
                  </div>
                  <div className="mt-4">
              ...
              <div className="">
                <div>
                  <div className="mr-[160px] mt-6">
                    <label className="text-[#33475b] text-[16px]">Industry your company belongs to</label>
                  </div>
                  <div className="mt-4">
                    <select className="w-[404px] border-b-[2px] border-[#cad5e2] bg-white">
                      <option disabled value="" selected>Select Option</option>
          ...
          {/* Div for strips*/}
          {/* */}
          <div className="absolute left-[1050px] -rotate-[20deg] -z-1">
            <div className="flex">
              <div className="bg-green-800 w-60 h-[1000px]"></div>
              <div className="bg-red-800 w-60 h-[1000px] ml-20"></div>
            </div>
          </div>
